...
extension PopoverLabel{
   public static let defaultStyle:Style = (arrowBoxStyle:ArrowBox.defaultArrowBoxStyle, text:defaultTextStyle, margin:defaultMargin, shadow:ShadowUtil.defaultShadowStyle)
